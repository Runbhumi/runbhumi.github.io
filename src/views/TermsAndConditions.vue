<template>
  <div style=" padding: 0 8rem ">
    ...
    <p>
      ...
      intellectual property rights related to it, still belong to Sai Rohan
      Bangari, Manas Gupta, Mohit. L, Hayat Tamboli.
    </p>
    <p>
      Sai Rohan Bangari, Manas Gupta, Mohit. L, Hayat Tamboli is committed to
      ...
      its services, at any time and for any reason. We will never charge you for
      the app or its services without making it very clear to you exactly what
      you’re paying for.
    </p>
    <p>
      The Runbhumi app stores and processes personal data that you have provided
      ...
      features and it could mean that the Runbhumi app won’t work properly or at
      all.
    </p>
    <div>
      <p>
    ...
    <p>
      You should be aware that there are certain things that Sai Rohan Bangari,
      Manas Gupta, Mohit. L, Hayat Tamboli will not take responsibility for.
      ...
      mobile network provider, but Sai Rohan Bangari, Manas Gupta, Mohit. L,
      Hayat Tamboli cannot take responsibility for the app not working at full
    ...
    <p>
      Along the same lines, Sai Rohan Bangari, Manas Gupta, Mohit. L, Hayat
      Tamboli cannot always take responsibility for the way you use the app i.e.
      You need to make sure that your device stays charged – if it runs out of
      battery and you can’t turn it on to avail the Service, Sai Rohan Bangari,
      Manas Gupta, Mohit. L, Hayat Tamboli cannot accept responsibility.
    </p>
    <p>
      With respect to Sai Rohan Bangari, Manas Gupta, Mohit. L, Hayat Tamboli’s
      responsibility for your use of the app, when you’re using the app, it’s
      important to bear in mind that although we endeavour to ensure that it is
      updated and correct at all times, we do rely on third parties to provide
      information to us so that we can make it available to you. Sai Rohan
      Bangari, Manas Gupta, Mohit. L, Hayat Tamboli accepts no liability for any
      loss, direct or indirect, you experience as a result of relying wholly on
    ...
    <p>
      ...
      Sai Rohan Bangari, Manas Gupta, Mohit. L, Hayat Tamboli does not promise
    ...
    <p>
      These terms and conditions are effective as of 2021-01-18
    </p>
    <p><strong>Contact Us</strong></p>
    <p>
      If you have any questions or suggestions about my Terms and Conditions, do
      not hesitate to contact me at bangarisairohan@gmail.com.
    </p>
    <!-- <p>
